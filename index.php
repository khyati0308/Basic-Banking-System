...
<body>
  <!-- Navbar -->
  <nav  class="navbar navbar-expand-lg navbar-dark  sticky-top" style="background-color: #511281;">
  ...
  <!-- End Navbar -->
   ...
   <section class="topContent">
    <div class="mainHeading">
      <div>
        <span class="main-content" style="font-size: 50px; color:#511281">TSF Banking</span>
      </div>
      <div style="margin-top: 12px;">
        <span class="sub-content">TSF Banking System for making transactions for users</span>
      </div>
      <br>
      <a href="#services"class="btn btn-lg btn-outline-light" style="background-color: #511281; color:#ffffff;">Get Started</a>
    </div>
  ...
  <section id="about" class="container">
    <h2 class="heading" style="font-size:50px;color:#511281">About Us</h2>
    <div class="container">
      <div class="row">
        <div class="col-md-6 mx-auto">
          <img class=" mt-3 " style="width:400px;" src="images/banking.svg" alt="TSF Bank">
        </div>
        <div class="col-md-6 mx-auto mt-4">
          <div>
            <span class="text" style="font-size:30px;color:#511281">TSF Bank</span>
          </div>
          <div class="mt-2">
          ...
          <a href="#services" class="btn btn-lg btn-outline-light" style="background-color: #511281; color:#ffffff;">Learn More</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="container" id="services">
    <h2 class="heading" style="font-size:50px; color:#511281">Our Services</h2>
      ...
      <div class="row">
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a href="transactionhistory.php" class="btn btn-outline-light" style="background-color: #511281; color:#ffffff;">View Transactions</a>
          </div>
        </div>
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a href="transfermoney.php" class="btn btn-outline-light" style="background-color: #511281; color:#ffffff;">Transfer Money</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="mx-auto" id="contact">
    <h2 class="heading" style="font-size:50px;color:#511281">Contact Us</h2>
    <form>
      <div class="row mb-3">
        <div class="col">
      ...
      <button type="submit" class="btn btn-lg btn-outline-light" style="background-color: #511281; color:#ffffff;">Submit</button>
  ...
  <!-- Footer -->
  <footer style="background-color:#511281">
    <div class="follow">
