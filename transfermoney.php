...
<!-- End Navbar -->
  ...
  <!-- Table -->
  <div class="container">
        <h2 class="text-center pt-4" style="color : #511281;margin-top: 30px;">Transfer Money</h2>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr style="color : #511281;">
                        <td class="py-2"><?php echo $rows['id'] ?></td>
                        <td class="py-2"><?php echo $rows['name']?></td>
                        <td class="py-2"><?php echo $rows['email']?></td>
                        <td class="py-2"><?php echo $rows['balance']?></td>
                        <td><a href="userdetails.php?id= <?php echo $rows['id'] ;?>"> <button style="color:#511281" class="btn btn-outline-light btn">View and Transact</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
